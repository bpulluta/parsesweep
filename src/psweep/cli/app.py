...
def run(
    ...
    reprocess: Annotated[
        bool,
        typer.Option("--reprocess/--skip-existing", help="Re-extract already-processed documents."),
    ] = False,
    fresh: Annotated[
        bool,
        typer.Option("--fresh", help="Ignore all caches — reprocess everything from scratch."),
    ] = False,
