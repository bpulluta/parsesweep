...
Quick start (programmatic):
    >>> from streamline_extract import DocumentExtractor, load_schema
...
For document discovery:
    >>> from streamline_extract import AcquisitionEngine, AcquisitionRequest
...
__version__ = "2.0.1"
__author__ = "StreamlineExtract Team"
__license__ = "MIT"
...
from streamline_extract.extraction import (  # noqa: E402
    DocumentExtractor,
    ExtractionResult,
    load_schema,
...
from streamline_extract.acquisition import (  # noqa: E402
    AcquisitionEngine,
    AcquisitionRequest,
    AcquisitionResult,
)
