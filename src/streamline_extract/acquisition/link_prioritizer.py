"""Heuristic link prioritizer for acquisition candidate ranking.
...
class PrioritizedCandidate:
    """An acquisition candidate augmented with heuristic priority metadata."""
...
class LinkPrioritizer:
    """Heuristic ranker for acquisition candidate URLs.
    ...
    ) -> tuple[list[AcquisitionCandidate], list[dict[str, Any]]]:
    ...
    def _score(
        self, candidate: AcquisitionCandidate
