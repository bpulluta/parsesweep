...
class CandidateSelector:
    ...
    def select(
        ...
        for target_idx, target_candidates in enumerate(candidates_by_target):
            ...
            dated: list[tuple[AcquisitionCandidate, date | None]] = [
    ...
    def _is_draft(self, candidate: AcquisitionCandidate) -> bool:
    ...
    def _is_relevant_candidate(self, candidate: AcquisitionCandidate) -> bool:
